-- TODO: before moving to evaluation, update server stuff below with your preferred model and make sure the config matches https://github.com/gerazov/ollama-chat.nvim#%EF%B8%8F-usage
return {
